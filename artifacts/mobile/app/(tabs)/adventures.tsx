    ...
    >
      ...
      <View style={styles.cardBody}>
        ...
        <View style={styles.cardFooter}>
          <Text style={styles.character}>{story.characterEmoji} {story.characterName}</Text>
    ...
    <View style={styles.container}>
      ...
      {isLoading ? (
        ...
        <FlatList
          ...
          scrollEnabled={(stories?.length ?? 0) > 0}
